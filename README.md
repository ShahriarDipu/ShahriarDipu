...
I'm a **MERN Stack Web Developer** from **Bangladesh 🇧🇩**, passionate about building modern web applications and learning new technologies.  
I enjoy turning complex problems into simple, beautiful, and intuitive solutions.

- ❤️ I enjoy programming and sharing knowledge  
- 💻 Most used line of code: `console.log("hello world")`
- 🌱 Currently improving my skills in **Next.js & System Design**
- 🤝 Open to collaboration on **Open Source & MERN Projects**
...
|-------------|------------|--------|
| MERN App | Full Stack MERN Application | ✅ Completed |
| Portfolio Website | Personal Developer Portfolio | 🚧 In Progress |
| Dashboard App | Admin Dashboard with Charts | 🚀 Live |
